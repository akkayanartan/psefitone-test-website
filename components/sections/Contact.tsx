    ...
    <section className="section contact-section" id="contact" ref={sectionRef}>
      <div className="section-inner">
        <div className="contact-card gsap-reveal">
          <div className="contact-emoji" aria-hidden="true">💬</div>
          <h3>Soruların mı var?</h3>
          <p>
            Kafandaki soru işaretlerini cevaplamak için buradayım. WhatsApp üzerinden yazarak
